...
[课程导航](../curriculum/index.md)将本路线展开为[全路线单元](../curriculum/course-units.md)和[前 4 周课次](../curriculum/first-four-weeks.md)。大纲按课程轮换组织教学，不改变本文件的阶段注册、依赖或退出门槛；实际顺序与进展仍由当前执行板维护。
